...
function displayChat(index){
    ...
    stored_name_data = '<li><a id= "chat1"><div class="textoverflow fontsizemenu">'+userData[index].uname+'</div><p class="textSnip">type a message</p></a></li>';
}
